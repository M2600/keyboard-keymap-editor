...
namespace Keyboard_configuration_software
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            _timer = new System.Timers.Timer(1000.0 / 5.0); // in milliseconds - you might have to play with this value to throttle your framerate depending on how involved your update and render code is 
        ...
        private void sendSerialCommunication(string message)
        {
            if(sendmessage != message && serialPortOpen)
            {
                ...
                catch
                {
                    Invoke((MethodInvoker)(() =>    // 受信用スレッドから切り替えてデータを書き込む
                    {
                        textBox1.AppendText("Port open error!" + "\r\n");
                    }));
                }
        ...
        {
            for (int i = 0; i < Math.Min(textBox1.Lines.Length,30); i++)
            {
